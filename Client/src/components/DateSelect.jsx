...
const DateSelect = forwardRef(({dateTime, id}, ref) => {
  ...
  return (
    <div id='dateSelect' ref={ref} className='pt-30'>
      <div className='f1ex flex-col md:flex-row items-center justify-between gap-10 relative p-8 bg-primary/10 border border-primary/20 rounded-lg'>
